...
//hamid
    ...
    private function user_to_array($item)
    {
        ...
        $telephonenumber = isset($item['ipphone'][0]) ? $item['ipphone'][0] : "";
        ...
        $user = array('samaccountname' => $samaccountname, 'samaccounttype' => $samaccounttype, 'givenname' => $givenname, 'displayname' => $displayname, 'mail' => $mail, 'department' => $department, 'telephonenumber' => $telephonenumber,   'useraccountcontrol' => $useraccountcontrol,'description' => $description, 'whencreated' => $create, 'whenchanged' => $change);
